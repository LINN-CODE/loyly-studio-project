...
import { Heart, Shield, Moon, Sparkles, Users } from "lucide-react";
    ...
    <section id="about" className="py-24 bg-white">
      <div className="container mx-auto px-8">
        <motion.div 
          ...
          ref={ref}
        >
          <h2 className="mb-4 text-gray-900 text-5xl font-bold">Health Benefits</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-10 max-w-5xl mx-auto">
          {benefits.map((benefit, index) => (
            ...
            >
              <motion.div 
                className="w-16 h-16 mb-6 flex items-center justify-center mx-auto"
                whileHover={{ scale: 1.1, rotate: 5 }}
                transition={{ duration: 0.3 }}
              >
                <benefit.icon className="w-12 h-12 text-gray-800 stroke-1" />
              </motion.div>
              <h3 className="mb-3 text-gray-900 text-2xl font-bold">{benefit.title}</h3>
