...
import { FinnishLegacy } from "./FinnishLegacy.js";
  ...
  return (
    <div className="bg-white pt-24">
      ...
      <div className="container mx-auto px-8 py-16 text-center">
        <h1 className="mb-4 text-gray-900 text-5xl font-bold">Our Story</h1>
        <p className="text-gray-500 max-w-3xl mx-auto text-[32px]">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-8">
          <div className="grid md:grid-cols-[1fr_1.5fr] gap-16 items-center max-w-6xl mx-auto">
            <div>
              <h2 className="mb-6 text-gray-900 text-4xl font-bold">Where it all started</h2>
        ...
        <div className="container mx-auto px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
            ...
            <div className="order-1 md:order-2">
              <h2 className="mb-6 text-gray-900 text-4xl font-bold">Why it matters</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
            <div>
              <h2 className="mb-6 text-gray-900 text-4xl font-bold">Our Vision of a Sanctuary for Mind, Body and Community</h2>
              <div className="space-y-6">
                <div>
                  <h3 className="text-gray-900 mb-2">Holistic Wellbeing</h3>
                  <p className="text-gray-600 leading-relaxed">
                ...
                <div>
                  <h3 className="text-gray-900 mb-2">Intergenerational Appeal</h3>
                  <p className="text-gray-600 leading-relaxed">
                ...
                <div>
                  <h3 className="text-gray-900 mb-2">Human Connection</h3>
                  <p className="text-gray-600 leading-relaxed">
