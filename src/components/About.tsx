          ...
          <div className="grid md:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
            <div>
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-[#2b2b2b] mb-2">Holistic Wellbeing</h3>
                  <p className="text-[#2b2b2b]/80 leading-relaxed">
                ...
                <div>
                  <h3 className="text-[#2b2b2b] mb-2">Intergenerational Appeal</h3>
                  <p className="text-[#2b2b2b]/80 leading-relaxed">
                ...
                <div>
                  <h3 className="text-[#2b2b2b] mb-2">Human Connection</h3>
                  <p className="text-[#2b2b2b]/80 leading-relaxed">
