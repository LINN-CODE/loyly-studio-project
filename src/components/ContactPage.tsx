      ...
      <div className="container mx-auto px-8 py-20">
        ...
        >
          ...
          <p className="text-gray-500 max-w-2xl mx-auto">
            Have questions or ready to experience authentic
            Finnish sauna? We'd love to hear from you.
          </p>
        </motion.div>
          ...
          >
            <div>
              ...
              <p className="text-gray-600 mb-12">
                Whether you're interested in a membership, have
                questions about our services, or want to book a
                private session, our team is here to help.
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  ...
                  <a
                    href="mailto:hello@loylystudio.sg"
                    className="text-gray-600 hover:text-gray-900 transition-colors"
                  >
                    hello@loylystudio.sg
                  </a>
                </div>
              </motion.div>
            ...
            <div className="border border-gray-200 overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-black/40">
                  <div className="text-center text-white p-8">
                    ...
                    <p className="text-white/90">
                      34 Siglap Drive, 456159, Singapore
                    </p>
                  </div>
                </div>
              </div>
              <div className="p-6 bg-gray-50">
                ...
                <p className="text-gray-600 mb-4">
                  Located in the heart of Siglap, löyly studio
                  is easily accessible by public transport and
                  car.
                </p>
                <div className="space-y-2 text-gray-600">
                  <p>
                    ...
                    10-minute walk from Siglap MRT Station
                  </p>
                  <p>
                    <span className="text-gray-900">
                      By Bus:
        ...
        >
          <h2 className="mb-6 text-gray-900">
            Ready to Experience Löyly?
          </h2>
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Join our community and discover the authentic
            Finnish sauna tradition. Book a session or become a
            member today.
          </p>
