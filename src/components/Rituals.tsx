    ...
    <section className="py-24 bg-white">
      <div className="container mx-auto px-8">
        ...
        <div className="max-w-6xl mx-auto">
          {/* Desktop View - Triangle Flow */}
          <div className="hidden md:block">
            <div className="relative">
              <div className="flex flex-col items-center gap-8">
                {/* Row 1: First box (centered at top) */}
                      ...
                      >
                        ...
                        >
                          ...
                          <motion.div
                            ...
                            className="mb-4"
                          >
                            <StepIcon className="w-12 h-12 text-gray-800 stroke-1" />
                          </motion.div>
                ...
                {/* Arrows row - both diagonal arrows on same level */}
                <div className="flex justify-center w-full relative h-16">
                  {/* Arrow from Heat to Cold Plunge (pointing down-left) */}
                  <motion.div
                  ...
                  >
                    <ArrowDown className="w-12 h-12 text-gray-400 -rotate-45" />
                  </motion.div>
                  
                  {/* Arrow from Rest back to Heat (pointing up-right) */}
                  <motion.div
                  ...
                  >
                    <ArrowDown className="w-12 h-12 text-gray-400 rotate-[135deg]" />
                  </motion.div>
                </div>

                {/* Row 2: Two boxes side by side (bottom of triangle) */}
                <div className="flex justify-center gap-24 w-full relative">
                  {[ritualSteps[1], ritualSteps[2]].map((step, index) => {
                    const StepIcon = step.icon;
                    return (
                      <motion.div
                        key={step.id}
                  ...
                  {/* Arrow from Cold Plunge to Rest (pointing right, positioned between the two boxes) */}
                  <motion.div
